...
export default function SettingsClient() {
  ...
  async function save() {
    ...
    try {
      ...
      setNotice({ tone: "success", message: data.persisted ? "Settings saved to your workspace." : "Settings saved for this browser." });
    } catch {
  ...
  return <main className="settings-page">
    ...
    <div className="settings-layout">
      <aside className="settings-index"><span className="overline">CONFIGURE</span><a href="#workspace">Workspace</a><a href="#direction">Editorial direction</a><a href="#models">Models &amp; routing</a><a href="#limits">Context &amp; limits</a><a href="#handoff">Handoff</a><div className="settings-index-note"><Icon name="lock" size={14} /><span>Changes are private to your workspace.</span></div></aside>
