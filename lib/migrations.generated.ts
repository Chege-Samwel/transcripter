...
CREATE INDEX IF NOT EXISTS transcripter_workflow_templates_owner_idx
  ...
  { version: "0004", name: "0004_fix_active_system_models", sql: `-- Auto-upgrade system models to user cascade defaults (NVIDIA Nemotron 3 Ultra, OpenRouter Gemma, Google Gemini)
UPDATE transcripter_system_settings
SET value = jsonb_build_object(
  'primaryModel', 'nvidia/nemotron-3-ultra-550b-a55b',
  'fallbackModels', jsonb_build_array('google/gemma-4-26b-a4b-it:free', 'gemini-2.0-flash')
),
updated_at = NOW(),
